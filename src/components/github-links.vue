<template>
  <p>
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width="16px" height="16px">
      ...
      /></svg
    >&nbsp; <a href="https://github.com/flashkot/chatstat" target="_blank">GitHub</a>, лицензия
    <a href="https://github.com/flashkot/chatstat/blob/master/LICENSE" target="_blank">MIT</a>.
  </p>
</template>
